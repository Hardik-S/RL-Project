...
For the course submission, the core report stands on its own. Supplementary implementation details, reproducibility notes, and benchmark artifacts are available in the repository documentation, especially \texttt{README.md}, \texttt{docs/REPRODUCIBILITY.md}, and the tracked per-run outputs used to rebuild the reported statistics.
