"""Backward-compatible alias for the full analysis build step."""
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Aggregate completed raw runs into report-ready outputs.")
